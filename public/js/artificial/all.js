...
var otherCheck = function(){
	...
	if (document.getElementById('difference').value=='shop'){
		var price_box = document.getElementById('price');
		object_array =[name_box,email_box,item_name_box,item_brand_box,price_box];
	
		for (var i = 0; i < object_array.length; i++) {
			boxes_array.push(object_array[i].value);
		}
		
	}
	else if (document.getElementById('difference').value=='free'){
		var price_box = document.getElementById('info');
		object_array =[name_box,email_box,item_name_box,item_brand_box,price_box];
		...
		for (var i = 0; i < boxes_array.length; i++) {
			if(boxes_array[i] ==""){
				if(i ==0){
					...
					price_box.style.border = "2px solid red";
				}
