								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="panel panel-default item solid">
										...
										<div class="panel-footer clearfix">
											...
											<a type="button" href="add-to-cart/shop/{{ $item->id }}" class="btn btn-success pull-right solid-two solid-text-light">Buy</a>
											<p class="post-title fontlize" style="color:black;cursor:pointer;"><span class="label label-primary solid-two solid-text-light"><span class="fa fa-money" style="color:white;"> </span> ZAR {{ $item->Price }}<span></p>
										</div>
									</div>	
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="panel panel-default item solid">
										...
										<div class="panel-footer clearfix">
											...
											<p style="opacity:0" class="pull-right">sl</p>
											<a type="button" href="add-to-cart/shop/{{ $item->id }}" class="btn btn-success pull-right solid-two solid-text-light">Buy</a>
											<p class="post-title fontlize solid-text-light" style="color:black;cursor:pointer;"><span class="label label-primary solid-two"><span class="fa fa-money" style="color:white;"> </span> ZAR {{ $item->Price }}<span></p>
										</div>
									</div>	
								</div>
								...
								<div class="modal fade" id='{{ 'modal'.$item->id }}'> 
					                <div class="modal-dialog modal-md"> 
					                    <div class="modal-content"> 
					                        ...
					                        <div class='modal-body'>
					                            <center> 
					                                <img class='img-thumbnail solid-two' src='{{ $item->Pics }}' style='width:80%px; height:250px'>
					                            </center>
					                            <p style="color:black;">
					                            	<span class="label label-primary solid-two solid-text-light">Price: <b><span class='solid-text-light-two fontlize'> ZAR {{ $item->Price }}</span></b></span>
				                                	<span class="label label-warning solid-two solid-text-light">Category: <b><span class='solid-text-light-two'>{{ $item->Category }}</span></b></span>
