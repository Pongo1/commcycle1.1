				...
				<div class="row">
					<div class="col-lg-12 col-md-12 text-center">
						<div class="section-title">
							<h2 class="section-title solid-text" id="commcycleTitle"><i class="glyphicon glyphicon-shopping-cart text text-success"></i><b> SHOP B</b></h2>
							...
							<a class="btn btn-info solid" href="shop"><i class="fa fa-backward"></i> Shop A </a> 
	  					</div>
					</div>
				</div>
			</div>
