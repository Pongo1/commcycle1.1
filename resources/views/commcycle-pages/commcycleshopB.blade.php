				...
				<div class="row">
					<div class="col-lg-12 col-md-12 text-center">
						<div class="section-title">
							<h2 class="section-title solid-text" id="commcycleTitle"><i class="glyphicon glyphicon-shopping-cart text text-success"></i><b> COMMCYCLE SHOP B</b></h2>
							...
							<a class="btn btn-info solid" href="commcycleshop"><i class="fa fa-backward"></i> Commcycle Shop A </a> 
	  					</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
						@forelse($no_pic_items as $item)
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="panel panel-default solid">
										...
										<div class="panel-footer clearfix">
											<p class="label label-primary solid"><i class="fa fa-money"></i> FREE </p>
											<a type="button" href="add-to-cart/commcycleB/{{ $item->id }}" class="btn btn-success pull-right solid">Buy</a>
										</div>
									</div>
								</div>
							...
							@endif
						@empty 
							<p class="alert alert-info solid">There are no items in Commcycle shop B for now. All items have been sold out</p>
