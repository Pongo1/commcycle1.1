									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										...
										<div class="panel panel-default item solid-two">
											...
											<div class="panel-footer clearfix">
												...
												<button class="btn btn-danger btn-xs pull-right solid-two" type='button' data-toggle='modal' data-target='#Free-item-{{ $free_item->id }}'><i class="glyphicon glyphicon-trash"></i></button>
