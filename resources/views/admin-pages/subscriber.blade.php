							...
							<div class="col-md-6 col-sm-9 col-xs-12 col-md-offset-1">
								<div class="panel panel-default solid">
									<div class="panel-heading solid" style="background-color:deeppink;">
										<h1 class="panel-title text-center" style="text-shadow: 0px 4px 8px rgba(0,0,0,0.8); font-size:50px;"><i class="fa fa-send" style="color:white;"></i> Communicate</h1><br>
										
									</div>
									<div class="panel-body" style="background-color:orange;">
										<form action="admin-communication/frimpong" method="get">
				                        	<div class="form-group">
					                            <div class="input-group">
					                                <span class="input-group-addon solid"><i class="glyphicon glyphicon-envelope blue"></i></span>
					                                <input type="email" name="personemail" placeholder="Email" class="form-control solid">
					                            </div>
				                        	</div>
				                        	<div class="form-group">
					                            <div class="input-group">
					                        ...
					                        <div class="form-group">
					                        	<label><input type="checkbox" name='allSubscribers'> Send message to all subscribers</label><br>
