						...
						<form action="docheckout" method="get">
	                        ...
	                        <div class="form-group">
		                        ...
		                        @foreach($products as $product)
		                        	@if($product['shop'] == 'commcycle'|| $product['shop'] == 'commcycleB')
		                        		<small>You can see this because one of the items in your shopping cart is from commcycle, and is free. Please tell us in a few sentences why we should give that item to you and not anyone else.</small>
					                    <div class="form-group">
				                            <div class="input-group">
