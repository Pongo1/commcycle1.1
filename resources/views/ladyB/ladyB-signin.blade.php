...
<html>
	<head>
        ...
        <title>LadyB Admin sign-in</title>
	...
	<body>
			...
			<div class="row" id="signInBar"> 
				<form action="ladyB-authentication" class="form-group" name="login" method="post" >
				{{ csrf_field() }}
					<div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-lg-offset-3"> 
						<div class="panel panel-primary" style="box-shadow:0 4px 10px rgba(0,0,0,1);"> 
							<div class="panel-heading " style="background:deeppink;">
								<img src="{{ asset('imgs/social.png') }}" class="img-responsive pull-left" style=" width:25px; height:25px">
								<h1 class="panel-title solid-text-light">  LadyB Admin Login</h1>
