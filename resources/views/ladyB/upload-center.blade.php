        ...
        @if(Session::get('lb-admin') == $admin->Name.":".$admin->Password )
    		...
    		<hr>
        				<div class="thumbnail solid" style="padding:15px" id="uploadbox">
        					<p class=" text-center text text-warning" style="color:white;font-size:15px">The size and price must be numbers. Please note, if you encounter any issues with uploads, contact frimpong via frimpong@commcycle.co. Everything you upload here will be moved straight to your section on the main commcycle website, and visible to everyone please do take care. Enjoy your patnership with commcycle</p>
        					<br>
        					<form action="ladyB-upload" method="post" enctype="multipart/form-data">
        					{{ csrf_field() }} 
        						<div class="row">       						 
        							<div class="form-group col-md-6 col-lg-6"> 
        								<input class="form-control solid" type = "text" placeholder="name of item" name="itemName">
        							</div>
         							<div class="form-group col-md-6 col-lg-6"> 
        								<input class="form-control solid" type = "number" placeholder="price of the item" name="itemPrice">
        							</div>       							       						
        						</div>
        						<div class="row">       						 
        							<div class="form-group col-md-6 col-lg-6"> 
        								<input class="form-control solid" type = "number" placeholder="Size of the item" name="itemSize">
        							</div>
         							<div class="form-group col-md-6 col-lg-6"> 
